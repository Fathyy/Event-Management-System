...
<div class="box box-primary">
    ...
    <!-- form start -->
    <form action="<?php echo WEB_ROOT ?>viewsprocess.php?cmd=create" method="post">
        <div class="box-body">
            <div class="form-group">
                <label for="name">name</label>
                <span id="sprytf_name">
                    <input type="text" name="name" class="form-control input-sm" placeholder="Username" id="name">
